...
<table style="table-layout: fixed" class='table m-table m-table--head-bg-success table-hover table-bordered'>
    <thead>
        <th width="220px">Projection Period</th>
        ...
        <?php
            ...
            $new_infrastructure_cost_period_projection = $scenario_data['new_infrastructure_cost_period_projection'];
    ...
    <tbody>
        @foreach($new_infrastructure_cost_period_projection as $item_key => $item_value)
        <tr>
